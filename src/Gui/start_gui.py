...
class StartGui():
    ...
    def build_start(self):
        ...
        pseudo_layout = BoxLayout(
            orientation="horizontal", padding=(10, 10, 10, 10), size_hint=(1, 0.3))
        button_layout = BoxLayout(orientation="horizontal", padding=(
            20, 10), spacing=30, size_hint=(1, 1))
        self.__pseudo_input = TextInput(
            multiline=False, size_hint=(1, .8), pos_hint={'y': 0})
        self.__button_start = Button(
            text='MasterMind', size_hint=(0.6, 0.5), pos_hint={'y': 0.4})
        self.__button_options = Button(
            text='Options', size_hint=(0.6, 0.5), pos_hint={'y': 0.4})
    ...
    def start_game_type(self):
        ...
        checkbox_normal = CheckBox(
            group="type", size_hint=(.1, 1), active=True)
